...
var carbonara = document.createElement("li");
carbonara.innerHTML = "1 Pizza Carbonara";
orderList.appendChild(carbonara);
orderList.removeChild(carbonara);
readyList.appendChild(carbonara);